...
return $settings = array(
    ...
    'idp' => array(
        ...
        'singleSignOnService' => array(
            ...
            'url' => 'dddd',//($idp_sso_url)?$idp_sso_url:$idp_host . '/saml2/idp/SSOService.php',
        ),
