<?php
$mysqli = new mysqli(env('DB_HOST','localhost'), env('DB_USERNAME', 'phpmyadmin'), env('DB_PASSWORD', 'phpmyadmin'), env('DB_DATABASE', 'ccad_db'));
...
$qry = "SELECT * FROM sso_login_details where id = 1";
