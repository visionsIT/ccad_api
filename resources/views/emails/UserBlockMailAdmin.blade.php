	...
	<table width="600" cellpadding="2" style="font-family: arial; border: 1px solid #ddd; border-collapse: collapse;margin:30px auto 0px; ">
		...
		<tr>
			<td align="left" valign="middle" style="padding: 20px;">
				<h4 style="font-size:20px;margin: 10px 0px 20px;">Hello Admin,</h4>

				<p style="margin: 22px 0px 24px; font-size: 16px;">Due to many wrong login attempts, {{ $data['name'] }}'s account has been blocked.</p>
				<p style="margin: 22px 0px 24px; font-size: 16px;"><b>Blocked Account Email: </b>{{ $data['user_email'] }}</p>
