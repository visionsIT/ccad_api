	...
	<table width="600" cellpadding="2" style="font-family: arial; border: 1px solid #ddd; border-collapse: collapse;margin:30px auto 0px; ">
		...
		<tr>
			<td align="left" valign="middle" style="padding: 20px;">
				...
				<p style="margin: 22px 0px 24px; font-size: 16px;">Please contact us at <a href="mailto:customerexperience@meritincentives.com">customerexperience@meritincentives.com</a> to unblock your account.</p>
