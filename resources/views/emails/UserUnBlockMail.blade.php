	...
	<table width="600" cellpadding="2" style="font-family: arial; border: 1px solid #ddd; border-collapse: collapse;margin:30px auto 0px; ">
		...
		<tr>
			<td align="left" valign="middle" style="padding: 20px;">
				...
				<p style="margin: 22px 0px 24px; font-size: 16px;">Your account has been unblocked by Admin. You can now login to your account.</p>

				<p style="margin: 22px 0px 24px; font-size: 16px;">If you continue to have problems logging into your account, please contact us at <a href="mailto:info@meriteincentives.com">info@meriteincentives.com</a>.</p>
