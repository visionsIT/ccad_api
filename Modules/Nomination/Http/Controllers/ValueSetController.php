                            ...
                            if($camSett->s_eligible_user_option == '0'){
                                ...
                                if($camSett->s_group_ids != null){
                                    ...
                                    foreach($groupIds as $grpID){
                                        $check_grps = DB::table('users_group_list')->distinct('user_group_id')->select('user_group_id')->where(['account_id'=>$id,'user_role_id'=>$role_id,'user_group_id'=>$grpID])->get()->toArray();
