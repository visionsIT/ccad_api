...
class UserCampaignsBudgetLogs extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_campaigns_budget_logs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('user_campaigns_budget_logs');
    }
}
